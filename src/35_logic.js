...
var NODE_DEFS = {
  ...
  'chest':   { label: '상자 재고', cat: 'in', ins: [], outs: ['개수'],
               cfg: [{ k: 'ent', t: 'ent', label: '대상 상자', filter: ['chest'] },
                     { k: 'item', t: 'item', label: '품목(빈칸=전체)' }] },
  'machine': { label: '기계 상태', cat: 'in', ins: [], outs: ['가동', '정체', '진행%'],
               cfg: [{ k: 'ent', t: 'ent', label: '대상 기계' }] },
  'power':   { label: '전력 만족도', cat: 'in', ins: [], outs: ['만족%', '공급kW', '수요kW'],
               cfg: [] },
  'timer':   { label: '타이머', cat: 'in', ins: [], outs: ['펄스', '위상%'],
               cfg: [{ k: 'period', t: 'num', label: '주기(초)', def: 5 }] },
  'belt':    { label: '벨트 센서', cat: 'in', ins: [], outs: ['개수'],
               cfg: [{ k: 'ent', t: 'ent', label: '대상 벨트', filter: ['belt', 'splitter'] },
                     { k: 'item', t: 'item', label: '품목(빈칸=전체)' }] },
  ...
  'enemy':   { label: '적 근접', cat: 'in', ins: [], outs: ['마릿수', '최근접거리'],
               cfg: [{ k: 'radius', t: 'num', label: '감지 반경(타일)', def: 30 }],
               tech: 'defense-ai' },
  ...
  'counter': { label: '카운터', cat: 'op', ins: ['증가', '리셋'], outs: ['값'],
               cfg: [{ k: 'max', t: 'num', label: '상한(0=무제한)', def: 0 }], tech: 'logic-mem' },
  ...
  'pid':     { label: 'PID 제어', cat: 'op', ins: ['목표', '측정'], outs: ['출력', '오차'],
               cfg: [{ k: 'kp', t: 'num', label: 'Kp', def: 1 }, { k: 'ki', t: 'num', label: 'Ki', def: 0 },
                     { k: 'kd', t: 'num', label: 'Kd', def: 0 }, { k: 'lim', t: 'num', label: '출력 제한', def: 100 }],
               tech: 'logic-ctrl' },
  ...
  'gate':    { label: '벨트 게이트', cat: 'out', ins: ['열림'], outs: [],
               cfg: [{ k: 'ent', t: 'ent', label: '대상 벨트', filter: ['belt', 'splitter'] }], tech: 'logic-ctrl' },
  'filter':  { label: '인서터 필터', cat: 'out', ins: ['선택'], outs: [],
               cfg: [{ k: 'ent', t: 'ent', label: '대상 인서터', filter: ['inserter'] },
                     { k: 'a', t: 'item', label: '0일 때 품목' },
                     { k: 'b', t: 'item', label: '1 이상일 때 품목' }], tech: 'logic-ctrl' },
  'fire':    { label: '터렛 사격허가', cat: 'out', ins: ['허가'], outs: [],
               cfg: [{ k: 'ent', t: 'ent', label: '대상 터렛', filter: ['turret'] }], tech: 'defense-ai' },
