...
var ADVANCED_STEPS = [
  ...
  {
    id: 'oil-control',
    title: '석유 라인을 제어기에 맡긴다',
    why: '석유는 <b>줄줄이 걸린 사슬</b>이라 한 칸이 막히면 앞이 통째로 논다. 사람이 보고 있을 수는 없다 — ' +
         '유체 잔량을 <b>읽어서</b> 앞단을 세우는 것이 이 게임이 계속 물어 온 그 질문의 석유판이다.',
    how: [
      '제어기를 <b>좌클릭</b>해 편집기를 연다',
      '입력에서 <b>유체 잔량</b>을 놓는다 — 대상은 석유 라인의 <b>파이프</b>',
      '<b>비교</b> 노드로 문턱을 잡는다 (예: 가스가 <b>&gt; 2000</b> 이면 남아도는 것이다)',
      '그 결과를 <b>기계 가동/정지</b>에 잇고 대상을 <b>정제소</b>로 한다',
      '읽으면 "<b>가스가 넘치면 정제소를 쉬게 한다</b>" 가 된다',
      '넘칠 때 세우면 원유도 아껴지고 전기도 아껴진다 — 광맥은 유한하다'
    ],
    need: '유체 잔량 노드는 <b>강철 제련</b>에서 열린다 · 문턱은 파이프 용량(한 칸 100)을 보고 정한다',
