...
(function () {
  ...
  // **톱니 조립기 증설은 두 번 시도해 두 번 다 실패했다.**
  //   (1) 't<1500' 만 걸었더니 시작 재고(회로 10·톱니 30·철판 60)로 t=0 에 3대를 지어
  //       부트스트랩 자재가 사라졌다 — 공장이 아예 안 자랐다(건물 4/21 · 연구 0/8)
  //   (2) t≥900 으로 미뤘더니 이번엔 **자리**가 없었다. 조립기 구역이 꽉 차 계획의
  //       녹팩 조립기(asm-green#3)가 밀렸고, 연구는 그대로 7/8 이었다
  // 이 공장은 자재뿐 아니라 **공간도 한계**다 — 무엇을 넣으면 무엇이 밀린다.
